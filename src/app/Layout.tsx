...
const navItems = [
  ...
  { to: '/homebrew', label: 'Homebrew', icon: 'M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.486-6.336l-3.276 3.277a3.004 3.004 0 01-2.25-2.25l3.276-3.276a4.5 4.5 0 00-6.336 4.486c.049.58.025 1.194-.14 1.743' },
];
...
export function Layout() {
  ...
  return (
    <div className="min-h-dvh flex flex-col bg-bg-primary">
      {/* Header */}
      <header className="safe-top bg-bg-secondary/80 backdrop-blur-lg border-b border-border-default px-4 py-3.5 flex items-center justify-between sticky top-0 z-30">
        ...
        <button
          ...
          className="text-text-muted hover:text-accent-gold transition-colors bg-transparent border-none cursor-pointer p-1.5 -mr-1.5 rounded-lg hover:bg-accent-gold/8"
          aria-label="Search"
        >
